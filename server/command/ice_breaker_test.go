...
func TestIceBreakerManual(t *testing.T) {
	...
	err := runCommands(t, SL, `
		/lotto rotation new ICE --beginning 2020-03-05T09:00PST --seed=1
		/lotto rotation param shift ICE --period weekly --duration 30m 
	...
	require.Equal(t, []bot.TestPost{
		...
		bot.TestPost{UserID: "test-user5", Message: "###### You have been scheduled for ICE#2.\n@test-user-username scheduled ICE#2.\n\nTODO runbook/info URL/channel"},
		bot.TestPost{UserID: "test-user9", Message: "###### You have been scheduled for ICE#2.\n@test-user-username scheduled ICE#2.\n\nTODO runbook/info URL/channel"},
...
func TestIceBreakerInsufficient(t *testing.T) {
	...
	err := runCommands(t, SL, `
		/lotto rotation new ICE --beginning 2020-03-05T09:00PST 
		/lotto rotation param shift ICE --period weekly --duration 30m 
