...
// Source: github.com/mattermost/mattermost-plugin-solar-lottery/server/sl (interfaces: PluginAPI)
...
func (mr *MockPluginAPIMockRecorder) GetBotUserID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBotUserID", reflect.TypeOf((*MockPluginAPI)(nil).GetBotUserID))
}
